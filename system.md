...
- ❌ No `Generated by` or `Created by AI` markers

Commits represent developer + agent collaborative work under the **developer's name only**.

If you find commits with AI attribution, they must be amended to remove the markers.
